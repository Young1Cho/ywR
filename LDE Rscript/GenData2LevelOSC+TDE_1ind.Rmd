...
# a0 = runif(totalPersons,-3,3) #Initial condition means
...
# Damped Oscillator model 2
# time-variant cov3 follows random
# TVcovType='Rand'
# cov3=rnorm((maxT+1)*totalPersons,0,1) #runif((maxT+1)*totalPersons,-3,3)
# str(cov3)
```
...
for (id in 1:totalPersons) {
  ...
  if (Model=="Osc"){  
      ...
      zeta= -0.04
      b3  =  0.3 + rnorm(1,0,sqrt(.04)) #+.2*cov1[id]
    parms <- c(eta, zeta, b3)
